...
This bot project was created using the [Enterprise People Bot](https://aka.ms/SSWSophieBotBot) template. You **must complete the configuration steps outlined below for your bot to function.**
