...
namespace SSW.SophieBot.LUIS.Migrator.HttpClients
{
    public class PeopleClient : IPeopleClient
    {
        ...
        private readonly LuisMigratorOptions _options;
        private readonly ILogger<PeopleClient> _logger;

        public PeopleClient(HttpClient httpClient, IOptions<LuisMigratorOptions> options, ILogger<PeopleClient> logger)
        {
